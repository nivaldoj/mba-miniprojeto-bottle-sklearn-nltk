...
def credito_get():
    ...
    return template("forms/form_credito.html", risco="-", renda="-", probabilidade="-")
...
def credito_post():
    ...
    # carrega o modelo
    modelo_nb = GaussianNB()
    modelo_nb = joblib.load('models/model_credito.pkl')
    ...
    # renderiza o template com os resultados
    return template("forms/form_credito.html", risco=clf, renda=renda, probabilidade=prb)
